(() => {
  const RESULTS = [
    { name: "Stardrop", type: "stardrop", rotation: [0, 0] },
    { name: "Širdis", type: "heart", rotation: [0, 180] },
    { name: "Širdis", type: "heart", rotation: [0, -90] },
    { name: "Širdis", type: "heart", rotation: [0, 90] },
    { name: "Junimo", type: "junimo", rotation: [-90, 0] },
    { name: "Junimo", type: "junimo", rotation: [90, 0] }
  ];
  ...
  class StardewDiceRoller {
    ...
    roll(forcedIndex) {
      ...
      this.cube.style.transform = `rotateX(${fullTurns + rolled.rotation[0]}deg) rotateY(${fullTurns + rolled.rotation[1]}deg)`;
